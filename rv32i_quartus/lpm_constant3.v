...
//lpm_constant CBX_AUTO_BLACKBOX="ALL" ENABLE_RUNTIME_MOD="NO" LPM_CVALUE=F17EB5A6 LPM_WIDTH=32 result
...
module  lpm_constant3_lpm_constant_s79
	( 
	result) ;
	output   [31:0]  result;
	...
	assign
		result = 32'b11110001011111101011010110100110;
endmodule //lpm_constant3_lpm_constant_s79
//VALID FILE
...
module lpm_constant3 (
	...
	lpm_constant3_lpm_constant_s79	lpm_constant3_lpm_constant_s79_component (
				.result (sub_wire0));
